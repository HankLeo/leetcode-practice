...
public final class TreePractices {
    public static void execute() {
        ...
        new _173_Binary_Search_Tree_Iterator().execute();
        new _222_Count_Complete_Tree_Nodes().execute();
        ...
        new _117_Populating_Next_Right_Pointers_in_Each_Node_II().execute();
        ...
        new _872_Leaf_Similar_Trees().execute();
